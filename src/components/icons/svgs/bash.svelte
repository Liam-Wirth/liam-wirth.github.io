<script>
  let darkMode = false; // Switch between dark and light modes
...
<style>
  .dark-mode .st0 {
    fill: #FFFFFF; /* Adjust as per your preference */
  }
  ...
  .light-mode .st0 {
    fill: #000000; /* Change to black for light mode */
  }
...
<!-- SVG code, conditionally styled based on darkMode value -->
